...
class Random(Node):
    ...
    def __init__(self, columns=5, rows_min=2, rows_max=10, value_min=0, value_max=9, seed=None):
    ...
    def update(self):
        ...
        self.o.set(np.random.randint(self._value_min, self._value_max + 1, size=shape))
