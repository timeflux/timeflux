...
class Broker(Node):
    ...
    def __init__(self, address_in='tcp://127.0.0.1:5559', address_out='tcp://127.0.0.1:5560'):
        """
...
class BrokerMonitored(Node):
    ...
    def __init__(self, address_in='tcp://127.0.0.1:5559', address_out='tcp://127.0.0.1:5560', timeout=5):
...
class BrokerLVC(Node):
    ...
    def __init__(self, address_in='tcp://127.0.0.1:5559', address_out='tcp://127.0.0.1:5560', timeout=1000):
        self._timeout = timeout
        try:
            context = zmq.Context.instance()
...
class Pub(Node):
    ...
    def __init__(self, topic, address='tcp://127.0.0.1:5559', serializer='pickle', wait=0):
        """Create a publisher"""
...
class Sub(Node):
    ...
    def __init__(self, topics=[''], address='tcp://127.0.0.1:5560', deserializer='pickle'):
        """Create a subscriber"""
        try:
            context = zmq.Context.instance()
